...
class Loaded_Gaussian_Policy(BasePolicy):
    ...
    def define_forward_pass(self, obs_bo):
        ...
        curr_activations_bd = tf.dtypes.cast(normedobs_bo, dtype=tf.float64)
    ...
    def read_layer(self, l):
        ...
        return l['AffineLayer']['W'].astype(np.float64), l['AffineLayer']['b'].astype(np.float64)
    ...
    def get_action(self, obs):
        ...
        return self.define_forward_pass(observation)
