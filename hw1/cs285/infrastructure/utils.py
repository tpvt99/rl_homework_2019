    ...
    while True:
        ...
        if render:
            if 'rgb_array' in render_mode:
                if hasattr(env, 'sim'):
                    env.sim.render(mode='window', camera_name='track', height=500, width=500)
                    image_obs.append(env.sim.render(mode='offscreen', camera_name='track', height=500, width=500)[::-1])
                    #image_obs.append(env.sim.render()[::-1])
