...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.agent = agent_class(self.env, self.params['agent_params']) # this is an instance of BCAgent class in bc_agent.py
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            training_returns = self.collect_training_trajectories(itr,
                                ...
                                self.params['batch_size']) ## TODO implement this function below, done
            paths, envsteps_this_batch, train_video_paths = training_returns
            self.total_envsteps += envsteps_this_batch

            # relabel the collected obs with actions from a provided expert policy
            if relabel_with_expert and itr>=start_relabel_with_expert:
                paths = self.do_relabel_with_expert(expert_policy, paths) ## TODO implement this function below, done
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        if itr == 0:
            ...
            paths, envsteps_this_batch = sample_trajectories(env = self.env, policy = collect_policy,
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            self.agent.train(ob_no = ob_batch, ac_na = ac_batch, re_n = re_batch, next_ob_no = next_ob_batch, terminal_n = terminal_batch)
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths):
        ...
        print(self.params['eval_batch_size'])
