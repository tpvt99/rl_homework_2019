...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        perform_random_action = eps < np.random.randn() or self.t < self.learning_starts
        ...
        self.replay_buffer.store_effect(idx = self.replay_buffer_idx, action=action, reward=reward, done=done)
